...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = np.random.randn(input_dim[1]*input_dim[2]*num_filters//4, hidden_dim)*weight_scale
    ...
    def loss(self, X, y=None):
        ...
        shape = out1.shape
        out1 = out1.reshape(out1.shape[0],np.prod(out1.shape[1:]))
        ...
        grads['W2'] += reg*W2
        # reshape dout to conv layer output!
        dout1 = dout1.reshape(shape)
